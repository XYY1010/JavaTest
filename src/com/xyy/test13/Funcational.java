...
interface Collector<T> extends UnaryFunction<T, T> {
	T result();	// Extract result of collection parameter
}
...
public class Funcational {
	...
	// the list, ignoring the return value. The function object
	// may act as a collecting parameter. so it is return at
	// the end.
