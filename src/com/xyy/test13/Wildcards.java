...
public class Wildcards {
	...
	static void rawArgs(Holder holder, Object arg) {
		...
		// T t = holder.get();
		// OK, but type information has been lostL
	...
	public static void main(String[] args) {
		...
		// Unchecked method invocation: exact1(Hokder<T>)
		...
		// Unchecked method invocation: exact1(Holder<T>, T)
		...
		// wildSubtype(Holder<? extends T>, T) is applied
		// to (Holder, Long)
		...
		// wildSubtype(Holder<? super T>, T) cannot be
		// applied to <Holder<capture of ?>, Long>
		// wildSubtype(bounded, lng);	// Error:
		// wildSubtype(Holder<? super T>, T) cannot be
